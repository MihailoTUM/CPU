...
module ALUUnit(
    ...
    assign lowerMulOutput = mulFixedOutput[15:0];


    DIV16 divFixed(clk, hold, inData1, inData2, divFixedOutput, divFixedRemainder, divFinished);
    ADDI16 addIFixed(inData1, inImmediate, addIFixedOutput, addIFixedCarryOut);
    ...
    always_comb 
        begin   
            case(inOperation)
                ...
                4'h3: outDataResult = lowerMulOutput;
    ...
    begin
        case(inOperation)
            ...
            4'h9: 
                begin
                    if(localBranchSuccess) JMPSignalToControl = 1;
